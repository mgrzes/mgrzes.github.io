...
<p>
  ...
  <div class="side">
        ...
        <p style="text-align:center;"> <img src="style/grzes2025.jpg" style="max-width: 60%; margin: 10px;"> </p>
        <ul>
...
<!--<p>
        ...
        <h3>Useful Links</h3>
        <ul>
          <li><a href="https://research.kent.ac.uk/artificial-intelligence-and-data-science/">AIDA Research Group @ Kent</a></li>
